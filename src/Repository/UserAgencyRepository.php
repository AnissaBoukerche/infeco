...
/**
 * @extends ServiceEntityRepository<UserAgency>
 *
 ...
 */
class UserAgencyRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(UserAgency $entity, bool $flush = false): void
    {
    ...
    public function remove(UserAgency $entity, bool $flush = false): void
    {
